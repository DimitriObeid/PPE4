...
CREATE TABLE `abonnement` (
  ...
  `categorieAbonnement` varchar(11) NOT NULL,
  `tarifAbonnement` int(11) NOT NULL,
...
CREATE TABLE `sports` (
  ...
  `sportFootball` varchar(10) NOT NULL,
  `sportBasketball` varchar(10) NOT NULL,
  `sportBaseball` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-03-22 13:14:13
